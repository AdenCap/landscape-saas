...
urlpatterns = [
    ...
    path("combine/", views.invoice_combine, name="invoice_combine"),
    path("unbilled/", views.unbilled_work, name="unbilled_work"),
    ...
    path("<int:invoice_id>/pay/<str:token>/pdf/", views.invoice_client_pdf, name="invoice_client_pdf"),
    ...
    path("<int:invoice_id>/line-items/<int:item_id>/payment/", views.mark_invoice_line_item_paid, name="mark_invoice_line_item_paid"),
    path("<int:invoice_id>/apply-promotion/", views.invoice_apply_promotion, name="invoice_apply_promotion"),
    path("<int:invoice_id>/charge-card/", views.charge_invoice_card_on_file, name="charge_invoice_card_on_file"),
    ...
    path("estimates/<int:estimate_id>/mark-accepted/", views.estimate_owner_accept, name="estimate_owner_accept"),
    ...
    path("estimates/<int:estimate_id>/accepted/<str:token>/", views.estimate_client_accepted, name="estimate_client_accepted"),
    path("estimates/<int:estimate_id>/deposit/<str:token>/stripe/", views.create_estimate_deposit_checkout_session, name="create_estimate_deposit_checkout"),
    path("promotions/", views.promotion_list, name="promotion_list"),
    path("promotions/create/", views.promotion_create, name="promotion_create"),
    path("promotions/<int:promo_id>/update-count/", views.promotion_update_count, name="promotion_update_count"),
    path("promotions/<int:promo_id>/redeem/", views.promotion_redeem, name="promotion_redeem"),
