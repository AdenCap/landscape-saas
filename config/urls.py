...
urlpatterns = [
    ...
    path("webhooks/stripe-connect/", include("stripe_connect.webhook_urls")),
    path("stripe-connect/", include(("stripe_connect.urls", "stripe_connect"), namespace="stripe_connect")),
